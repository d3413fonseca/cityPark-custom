    ...
    <body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        <div class="wrapper">
            ...
            <div class="preloader flex-column justify-content-center align-items-center">
                <img class="animation__wobble" src="{{ URL::asset('dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
            </div>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('admin.clientes')}}" class="nav-link">
                                            <i class="far fa-user" style="margin-left: 35px;"></i>
                                            <p>&nbsp;&nbsp;&nbsp;Cliente</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin.rfid')}}" class="nav-link">
                                            <i class="far fa-address-card" style="margin-left: 35px;"></i>
                                            <p>&nbsp;&nbsp;&nbsp;RFID</p>
                                        </a>
                                    </li>
                                </ul>
